...
public:
	...
	~RepastHPCDemoModel();
	void init(); void requestAgents(); void cancelAgentRequests(); void connectAgentNetwork();
	void removeLocalAgents(); void moveAgents();
	void doSomething(); void initSchedule(repast::ScheduleRunner& runner); void recordResults();
};
#endif
// Eliminated
/*
